...
def wyszukaj_autora():
    try:
        ...
        if choice == '1':
            ...
            query = (f'SELECT id_autora, imie, nazwisko FROM autorzy WHERE id_autora={id_autora}')
        ...
        input('Error occured. Press any key to return to main menu...')
        main_menu()
